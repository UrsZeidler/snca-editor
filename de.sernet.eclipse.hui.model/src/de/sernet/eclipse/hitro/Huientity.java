...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Huientity</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface Huientity extends EObject {
	 ...
	 *        extendedMetaData="kind='element' name='huiproperty' group='#group:0'"
	 * @generated
	 */
	EList<Huiproperty> getHuiproperty();

	/**
	 * Returns the value of the '<em><b>Huipropertygroup</b></em>' containment reference list.
	 * The list contents are of type {@link de.sernet.eclipse.hitro.Huipropertygroup}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Huipropertygroup</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Huipropertygroup</em>' containment reference list.
	 * @see de.sernet.eclipse.hitro.HitroPackage#getHuientity_Huipropertygroup()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='huipropertygroup' group='#group:0'"
	 * @generated
	 */
	EList<Huipropertygroup> getHuipropertygroup();

	/**
	 * Returns the value of the '<em><b>Huirelation</b></em>' containment reference list.
	 * The list contents are of type {@link de.sernet.eclipse.hitro.Huirelation}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Huirelation</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Huirelation</em>' containment reference list.
	 * @see de.sernet.eclipse.hitro.HitroPackage#getHuientity_Huirelation()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='huirelation' group='#group:0'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.sernet.eclipse.hitro.Huientity#getId <em>Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link de.sernet.eclipse.hitro.Huientity#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
