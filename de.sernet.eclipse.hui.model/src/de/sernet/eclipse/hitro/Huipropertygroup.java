 ...
 *
 * <!-- begin-model-doc --> Group of properties, may have dependencies, which
 * means it will only be displayed when one of the given options has been
 * previously selected. <!-- end-model-doc -->
 *
 * <p>
 * The following features are supported:
 * </p>
 * <ul>
 * <li>{@link de.sernet.eclipse.hitro.Huipropertygroup#getDepends
 * <em>Depends</em>}</li>
 * <li>{@link de.sernet.eclipse.hitro.Huipropertygroup#getHuiproperty
 * <em>Huiproperty</em>}</li>
 * <li>{@link de.sernet.eclipse.hitro.Huipropertygroup#getColumns
 * <em>Columns</em>}</li>
 * <li>{@link de.sernet.eclipse.hitro.Huipropertygroup#getId <em>Id</em>}</li>
 * <li>{@link de.sernet.eclipse.hitro.Huipropertygroup#getName
 * <em>Name</em>}</li>
 * <li>{@link de.sernet.eclipse.hitro.Huipropertygroup#getTags
 * <em>Tags</em>}</li>
 * </ul>
 *
...
public interface Huipropertygroup extends EObject {
    /**
     * Returns the value of the '<em><b>Depends</b></em>' reference list. The
     * list contents are of type {@link de.sernet.eclipse.hitro.Depends}. <!--
     * begin-user-doc -->
     * <p>
     ...
     * @model resolveProxies="false" extendedMetaData="kind='element'
     *        name='depends'"
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Columns</b></em>' attribute. The default
     * value is <code>"1"</code>. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Columns</em>' attribute isn't clear, there
     ...
     * '{@link de.sernet.eclipse.hitro.Huipropertygroup#getColumns
     * <em>Columns</em>}' attribute is set. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
