 ...
 * </p>
 * <ul>
 *   <li>{@link de.sernet.eclipse.hitro.impl.ReferenceImpl#getEntitytype <em>Entitytype</em>}</li>
 *   <li>{@link de.sernet.eclipse.hitro.impl.ReferenceImpl#getLinkType <em>Link Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenceImpl extends MinimalEObjectImpl.Container implements Reference {
	/**
	 * The cached value of the '{@link #getEntitytype() <em>Entitytype</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getEntitytype()
	 * @generated
	...
	public void setEntitytype(Huientity newEntitytype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HitroPackage.REFERENCE__ENTITYTYPE, oldEntitytype, entitytype));
	}
	...
	public void setLinkType(String newLinkType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HitroPackage.REFERENCE__LINK_TYPE, oldLinkType, linkType));
	}
