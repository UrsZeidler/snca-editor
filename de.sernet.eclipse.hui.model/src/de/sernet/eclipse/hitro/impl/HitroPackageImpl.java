...
public class HitroPackageImpl extends EPackageImpl implements HitroPackage {
     ...
     * 
     * <p>
     * This method is used to initialize {@link HitroPackage#eINSTANCE} when
    ...
    public static HitroPackage init() {
        if (isInited)
            return (HitroPackage) EPackage.Registry.INSTANCE.getEPackage(HitroPackage.eNS_URI);

        // Obtain or create and register package
        HitroPackageImpl theHitroPackage = (HitroPackageImpl) (EPackage.Registry.INSTANCE
                .get(eNS_URI) instanceof HitroPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
                        : new HitroPackageImpl());
    ...
    public void initializePackageContents() {
        ...
        initEClass(defaultRuleEClass, DefaultRule.class, "DefaultRule", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getDefaultRule_Param(), this.getParam(), null, "param", null, 0, -1,
                DefaultRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDefaultRule_Class(), theXMLTypePackage.getString(), "class", null, 1, 1,
                DefaultRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(dependsEClass, Depends.class, "Depends", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getDepends_Inverse(), theXMLTypePackage.getBoolean(), "inverse", "false", 0,
                1, Depends.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDepends_Option(), this.getHuiproperty(), null, "option", null, 1, 1,
                Depends.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDepends_Value(), theXMLTypePackage.getString(), "value", null, 0, 1,
                Depends.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getDocumentRoot_Huientities(), this.getHuientities(), null, "huientities",
                null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

        initEClass(huientitiesEClass, Huientities.class, "Huientities", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getHuientities_Huientity(), this.getHuientity(), null, "huientity", null, 1,
                -1, Huientities.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(huientityEClass, Huientity.class, "Huientity", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getHuientity_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0,
                -1, Huientity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
                !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getHuientity_Huiproperty(), this.getHuiproperty(), null, "huiproperty", null,
                0, -1, Huientity.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEReference(getHuientity_Huipropertygroup(), this.getHuipropertygroup(), null,
                "huipropertygroup", null, 0, -1, Huientity.class, IS_TRANSIENT, IS_VOLATILE,
                IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                IS_DERIVED, IS_ORDERED);
        initEReference(getHuientity_Huirelation(), this.getHuirelation(), null, "huirelation", null,
                0, -1, Huientity.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuientity_Id(), theXMLTypePackage.getID(), "id", null, 1, 1,
                Huientity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuientity_Name(), theXMLTypePackage.getString(), "name", null, 0, 1,
                Huientity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(huipropertyEClass, Huiproperty.class, "Huiproperty", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getHuiproperty_Depends(), this.getDepends(), null, "depends", null, 0, -1,
                Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getHuiproperty_References(), this.getReference(), null, "references", null,
                0, 1, Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getHuiproperty_DefaultRule(), this.getDefaultRule(), null, "defaultRule",
                null, 0, 1, Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getHuiproperty_ValidationRule(), this.getValidationRule(), null,
                "validationRule", null, 0, -1, Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getHuiproperty_Option(), this.getOption(), null, "option", null, 0, -1,
                Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuiproperty_CrudButtons(), theXMLTypePackage.getBoolean(), "crudButtons",
                "false", 0, 1, Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuiproperty_DefaultValue(), theXMLTypePackage.getInt(), "defaultValue",
                "0", 0, 1, Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuiproperty_Editable(), theXMLTypePackage.getBoolean(), "editable",
                "true", 0, 1, Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuiproperty_Focus(), theXMLTypePackage.getBoolean(), "focus", "false", 0,
                1, Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuiproperty_Id(), theXMLTypePackage.getID(), "id", null, 1, 1,
                Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
                IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuiproperty_Inputtype(), this.getInputtypes(), "inputtype", "line", 0, 1,
                Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuiproperty_IsURL(), theXMLTypePackage.getBoolean(), "isURL", "false", 0,
                1, Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuiproperty_Max(), theXMLTypePackage.getInt(), "max", null, 0, 1,
                Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuiproperty_Min(), theXMLTypePackage.getInt(), "min", null, 0, 1,
                Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuiproperty_Name(), theXMLTypePackage.getString(), "name", null, 0, 1,
                Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuiproperty_Report(), theXMLTypePackage.getBoolean(), "report", "true", 0,
                1, Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuiproperty_Required(), theXMLTypePackage.getBoolean(), "required",
                "false", 0, 1, Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuiproperty_ShowInObjectBrowser(), theXMLTypePackage.getBoolean(),
                "showInObjectBrowser", "false", 0, 1, Huiproperty.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEAttribute(getHuiproperty_Tags(), theXMLTypePackage.getString(), "tags", null, 0, 1,
                Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuiproperty_Textrows(), theXMLTypePackage.getInt(), "textrows", "4", 0, 1,
                Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuiproperty_Tooltip(), theXMLTypePackage.getString(), "tooltip", null, 0,
                1, Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuiproperty_Visible(), theXMLTypePackage.getBoolean(), "visible", "true",
                0, 1, Huiproperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(huipropertygroupEClass, Huipropertygroup.class, "Huipropertygroup", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getHuipropertygroup_Depends(), this.getDepends(), null, "depends", null, 0,
                -1, Huipropertygroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
                IS_ORDERED);
        initEReference(getHuipropertygroup_Huiproperty(), this.getHuiproperty(), null,
                "huiproperty", null, 0, -1, Huipropertygroup.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuipropertygroup_Columns(), theXMLTypePackage.getInt(), "columns", "1", 0,
                1, Huipropertygroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuipropertygroup_Id(), theXMLTypePackage.getID(), "id", null, 1, 1,
                Huipropertygroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
                IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuipropertygroup_Name(), theXMLTypePackage.getString(), "name", null, 1,
                1, Huipropertygroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuipropertygroup_Tags(), theXMLTypePackage.getString(), "tags", null, 0,
                1, Huipropertygroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(huirelationEClass, Huirelation.class, "Huirelation", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getHuirelation_Id(), theXMLTypePackage.getID(), "id", null, 1, 1,
                Huirelation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
                IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuirelation_Name(), theXMLTypePackage.getString(), "name", null, 0, 1,
                Huirelation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuirelation_Reversename(), theXMLTypePackage.getString(), "reversename",
                null, 0, 1, Huirelation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getHuirelation_To(), this.getHuientity(), null, "to", null, 1, 1,
                Huirelation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHuirelation_Tooltip(), theXMLTypePackage.getString(), "tooltip", null, 0,
                1, Huirelation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(optionEClass, Option.class, "Option", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getOption_Id(), theXMLTypePackage.getID(), "id", null, 1, 1, Option.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEAttribute(getOption_Name(), theXMLTypePackage.getString(), "name", null, 0, 1,
                Option.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getOption_Value(), theXMLTypePackage.getDecimal(), "value", null, 0, 1,
                Option.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(paramEClass, Param.class, "Param", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getParam_Mixed(), ecorePackage.getEFeatureMapEntry(), "mixed", null, 0, -1,
                Param.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getParam_Id(), theXMLTypePackage.getID(), "id", null, 1, 1, Param.class,
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);

        initEClass(referenceEClass, Reference.class, "Reference", !IS_ABSTRACT, !IS_INTERFACE,
                IS_GENERATED_INSTANCE_CLASS);
        initEReference(getReference_Entitytype(), this.getHuientity(), null, "entitytype", null, 0,
                1, Reference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getReference_LinkType(), theXMLTypePackage.getIDREF(), "linkType", null, 0,
                1, Reference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(validationRuleEClass, ValidationRule.class, "ValidationRule", !IS_ABSTRACT,
                !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getValidationRule_Param(), this.getParam(), null, "param", null, 0, -1,
                ValidationRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getValidationRule_Class(), theXMLTypePackage.getString(), "class", null, 1,
                1, ValidationRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getValidationRule_Hint(), theXMLTypePackage.getString(), "hint", null, 0, 1,
                ValidationRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
                !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEDataType(inputtypesObjectEDataType, Inputtypes.class, "InputtypesObject",
    ...
    protected void createExtendedMetaDataAnnotations() {
        ...
        addAnnotation(defaultRuleEClass, source,
                new String[] { "name", "defaultRule_._type", "kind", "elementOnly" });
        addAnnotation(getDefaultRule_Param(), source,
                new String[] { "kind", "element", "name", "param" });
        addAnnotation(getDefaultRule_Class(), source,
                new String[] { "kind", "attribute", "name", "class" });
        addAnnotation(dependsEClass, source,
                new String[] { "name", "dependstype", "kind", "empty" });
        addAnnotation(getDepends_Inverse(), source,
                new String[] { "kind", "attribute", "name", "inverse" });
        addAnnotation(getDepends_Option(), source,
                new String[] { "kind", "attribute", "name", "option" });
        addAnnotation(getDepends_Value(), source,
        ...
        addAnnotation(getDocumentRoot_Huientities(), source, new String[] { "kind", "element",
                "name", "huientities", "namespace", "##targetNamespace" });
        addAnnotation(huientitiesEClass, source,
                new String[] { "name", "huientities_._type", "kind", "elementOnly" });
        addAnnotation(getHuientities_Huientity(), source,
                new String[] { "kind", "element", "name", "huientity" });
        addAnnotation(huientityEClass, source,
                new String[] { "name", "huientitytype", "kind", "elementOnly" });
        addAnnotation(getHuientity_Group(), source,
                new String[] { "kind", "group", "name", "group:0" });
        addAnnotation(getHuientity_Huiproperty(), source,
                new String[] { "kind", "element", "name", "huiproperty", "group", "#group:0" });
        addAnnotation(getHuientity_Huipropertygroup(), source, new String[] { "kind", "element",
                "name", "huipropertygroup", "group", "#group:0" });
        addAnnotation(getHuientity_Huirelation(), source,
                new String[] { "kind", "element", "name", "huirelation", "group", "#group:0" });
        addAnnotation(getHuientity_Id(), source,
                new String[] { "kind", "attribute", "name", "id" });
        addAnnotation(getHuientity_Name(), source,
                new String[] { "kind", "attribute", "name", "name" });
        addAnnotation(huipropertyEClass, source,
                new String[] { "name", "huipropertytype", "kind", "elementOnly" });
        addAnnotation(getHuiproperty_Depends(), source,
                new String[] { "kind", "element", "name", "depends" });
        addAnnotation(getHuiproperty_References(), source,
                new String[] { "kind", "element", "name", "references" });
        addAnnotation(getHuiproperty_DefaultRule(), source,
                new String[] { "kind", "element", "name", "defaultRule" });
        addAnnotation(getHuiproperty_ValidationRule(), source,
                new String[] { "kind", "element", "name", "validationRule" });
        addAnnotation(getHuiproperty_Option(), source,
                new String[] { "kind", "element", "name", "option" });
        addAnnotation(getHuiproperty_CrudButtons(), source,
                new String[] { "kind", "attribute", "name", "crudButtons" });
        addAnnotation(getHuiproperty_DefaultValue(), source,
                new String[] { "kind", "attribute", "name", "defaultValue" });
        addAnnotation(getHuiproperty_Editable(), source,
                new String[] { "kind", "attribute", "name", "editable" });
        addAnnotation(getHuiproperty_Focus(), source,
                new String[] { "kind", "attribute", "name", "focus" });
        addAnnotation(getHuiproperty_Id(), source,
                new String[] { "kind", "attribute", "name", "id" });
        addAnnotation(getHuiproperty_Inputtype(), source,
                new String[] { "kind", "attribute", "name", "inputtype" });
        addAnnotation(getHuiproperty_IsURL(), source,
                new String[] { "kind", "attribute", "name", "isURL" });
        addAnnotation(getHuiproperty_Max(), source,
                new String[] { "kind", "attribute", "name", "max" });
        addAnnotation(getHuiproperty_Min(), source,
                new String[] { "kind", "attribute", "name", "min" });
        addAnnotation(getHuiproperty_Name(), source,
                new String[] { "kind", "attribute", "name", "name" });
        addAnnotation(getHuiproperty_Report(), source,
                new String[] { "kind", "attribute", "name", "report" });
        addAnnotation(getHuiproperty_Required(), source,
                new String[] { "kind", "attribute", "name", "required" });
        addAnnotation(getHuiproperty_ShowInObjectBrowser(), source,
                new String[] { "kind", "attribute", "name", "showInObjectBrowser" });
        addAnnotation(getHuiproperty_Tags(), source,
                new String[] { "kind", "attribute", "name", "tags" });
        addAnnotation(getHuiproperty_Textrows(), source,
                new String[] { "kind", "attribute", "name", "textrows" });
        addAnnotation(getHuiproperty_Tooltip(), source,
                new String[] { "kind", "attribute", "name", "tooltip" });
        addAnnotation(getHuiproperty_Visible(), source,
                new String[] { "kind", "attribute", "name", "visible" });
        addAnnotation(huipropertygroupEClass, source,
                new String[] { "name", "huipropertygrouptype", "kind", "elementOnly" });
        addAnnotation(getHuipropertygroup_Depends(), source,
                new String[] { "kind", "element", "name", "depends" });
        addAnnotation(getHuipropertygroup_Huiproperty(), source,
                new String[] { "kind", "element", "name", "huiproperty" });
        addAnnotation(getHuipropertygroup_Columns(), source,
                new String[] { "kind", "attribute", "name", "columns" });
        addAnnotation(getHuipropertygroup_Id(), source,
                new String[] { "kind", "attribute", "name", "id" });
        addAnnotation(getHuipropertygroup_Name(), source,
                new String[] { "kind", "attribute", "name", "name" });
        addAnnotation(getHuipropertygroup_Tags(), source,
                new String[] { "kind", "attribute", "name", "tags" });
        addAnnotation(huirelationEClass, source,
                new String[] { "name", "huirelationtype", "kind", "empty" });
        addAnnotation(getHuirelation_Id(), source,
                new String[] { "kind", "attribute", "name", "id" });
        addAnnotation(getHuirelation_Name(), source,
                new String[] { "kind", "attribute", "name", "name" });
        addAnnotation(getHuirelation_Reversename(), source,
                new String[] { "kind", "attribute", "name", "reversename" });
        addAnnotation(getHuirelation_To(), source,
                new String[] { "kind", "attribute", "name", "to" });
        addAnnotation(getHuirelation_Tooltip(), source,
                new String[] { "kind", "attribute", "name", "tooltip" });
        addAnnotation(inputtypesEEnum, source, new String[] { "name", "inputtypes" });
        addAnnotation(inputtypesObjectEDataType, source,
                new String[] { "name", "inputtypes:Object", "baseType", "inputtypes" });
        addAnnotation(optionEClass, source,
                new String[] { "name", "option_._type", "kind", "empty" });
        addAnnotation(getOption_Id(), source, new String[] { "kind", "attribute", "name", "id" });
        addAnnotation(getOption_Name(), source,
                new String[] { "kind", "attribute", "name", "name" });
        addAnnotation(getOption_Value(), source,
                new String[] { "kind", "attribute", "name", "value" });
        addAnnotation(paramEClass, source, new String[] { "name", "param", "kind", "mixed" });
        addAnnotation(getParam_Mixed(), source,
                new String[] { "kind", "elementWildcard", "name", ":mixed" });
        addAnnotation(getParam_Id(), source, new String[] { "kind", "attribute", "name", "id" });
        addAnnotation(referenceEClass, source,
                new String[] { "name", "referencestype", "kind", "empty" });
        addAnnotation(getReference_Entitytype(), source,
                new String[] { "kind", "attribute", "name", "entitytype" });
        addAnnotation(getReference_LinkType(), source,
                new String[] { "kind", "attribute", "name", "linkType" });
        addAnnotation(validationRuleEClass, source,
                new String[] { "name", "validationRule_._type", "kind", "elementOnly" });
        addAnnotation(getValidationRule_Param(), source,
                new String[] { "kind", "element", "name", "param" });
        addAnnotation(getValidationRule_Class(), source,
                new String[] { "kind", "attribute", "name", "class" });
        addAnnotation(getValidationRule_Hint(), source,
                new String[] { "kind", "attribute", "name", "hint" });
    }
