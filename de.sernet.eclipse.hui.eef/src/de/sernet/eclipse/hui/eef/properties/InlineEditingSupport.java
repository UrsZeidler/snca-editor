...
class InlineEditingSupport<T> extends ObservableValueEditingSupport {
    ...
    protected IObservableValue<T> doCreateElementObservable(Object element, ViewerCell cell) {
        // IObservableValue<T> value = BeanProperties.value(propertyName,
        // element.getClass()).observe(element);
