 ...
 * 
 */
public class CustomDocumentRootPropertiesEditionPartForm extends SectionPropertiesEditingPart
     ...
     */
    public CustomDocumentRootPropertiesEditionPartForm() {
        super();
    }
     ...
     * 
     */
    public CustomDocumentRootPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
    ...
    protected Composite createMixedMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        mixed = widgetFactory.createText(parent, "", SWT.READ_ONLY|SWT.MULTI); //$NON-NLS-1$
        GridData mixedData = new GridData(SWT.FILL,SWT.TOP,true,false);
        mixedData.horizontalSpan = 2;
        mixedData.verticalSpan = 4;
...
//                            new PropertiesEditionEvent(CustomDocumentRootPropertiesEditionPartForm.this,
