 ...
 */
package de.sernet.eclipse.hui.eef.provider;
...
import de.sernet.eclipse.hui.eef.properties.part.forms.CustomDocumentRootPropertiesEditionPartForm;
import de.sernet.eclipse.hui.eef.properties.part.forms.CustomHuipropertyPropertiesEditionPartForm;
import de.sernet.eclipse.hui.eef.properties.part.impl.CustomHuipropertyPropertiesEditionPartImpl;
...
public class HitroPropertiesEditionPartProvider implements IPropertiesEditionPartProvider {
    ...
    public IPropertiesEditionPart getPropertiesEditionPart(Object key, int kind,
        ...
        if (key == HitroViewsRepository.DocumentRoot.class) {
            ...
            if (kind == HitroViewsRepository.FORM_KIND)
                return new CustomDocumentRootPropertiesEditionPartForm(component);
        }
        ...
        if (key == HitroViewsRepository.Huiproperty.class) {
            if (kind == HitroViewsRepository.SWT_KIND)
                return new CustomHuipropertyPropertiesEditionPartImpl(component);
            if (kind == HitroViewsRepository.FORM_KIND)
                return new CustomHuipropertyPropertiesEditionPartForm(component);
        }
