...
public class ValidationRulePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public ValidationRulePropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject validationRule, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(HitroViewsRepository.ValidationRule.Properties.param)) {
                paramSettings = new ReferencesTableSettings(validationRule,
            ...
            if (isAccessible(HitroViewsRepository.ValidationRule.Properties.class_))
                basePart.setClass_(EEFConverterUtil.convertToString(XMLTypePackage.Literals.STRING,
                        validationRule.getClass_()));

            if (isAccessible(HitroViewsRepository.ValidationRule.Properties.hint))
                basePart.setHint(EEFConverterUtil.convertToString(XMLTypePackage.Literals.STRING,
                        validationRule.getHint()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (HitroViewsRepository.ValidationRule.Properties.param == event.getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(
                        editingContext, this, paramSettings, editingContext.getAdapterFactory());
        ...
        if (HitroViewsRepository.ValidationRule.Properties.class_ == event.getAffectedEditor()) {
            validationRule.setClass((java.lang.String) EEFConverterUtil.createFromString(
        ...
        if (HitroViewsRepository.ValidationRule.Properties.hint == event.getAffectedEditor()) {
            validationRule.setHint((java.lang.String) EEFConverterUtil.createFromString(
                    XMLTypePackage.Literals.STRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (HitroPackage.eINSTANCE.getValidationRule_Param().equals(msg.getFeature())
                    && isAccessible(HitroViewsRepository.ValidationRule.Properties.param))
                basePart.updateParam();
            if (HitroPackage.eINSTANCE.getValidationRule_Class().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(HitroViewsRepository.ValidationRule.Properties.class_)) {
                if (msg.getNewValue() != null) {
                    basePart.setClass_(EcoreUtil.convertToString(XMLTypePackage.Literals.STRING,
                            msg.getNewValue()));
                } else {
                    basePart.setClass_("");
                }
            }
            if (HitroPackage.eINSTANCE.getValidationRule_Hint().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(HitroViewsRepository.ValidationRule.Properties.hint)) {
                if (msg.getNewValue() != null) {
                    basePart.setHint(EcoreUtil.convertToString(XMLTypePackage.Literals.STRING,
                            msg.getNewValue()));
                } else {
                    basePart.setHint("");
                }
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                if (HitroViewsRepository.ValidationRule.Properties.class_ == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(HitroPackage.eINSTANCE
                                .getValidationRule_Class().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            HitroPackage.eINSTANCE.getValidationRule_Class().getEAttributeType(),
                            newValue);
                }
                if (HitroViewsRepository.ValidationRule.Properties.hint == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                HitroPackage.eINSTANCE.getValidationRule_Hint().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            HitroPackage.eINSTANCE.getValidationRule_Hint().getEAttributeType(),
