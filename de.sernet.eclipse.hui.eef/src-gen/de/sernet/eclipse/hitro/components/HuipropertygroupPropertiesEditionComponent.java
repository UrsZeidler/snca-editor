 ...
 * 
 */
public class HuipropertygroupPropertiesEditionComponent
     ...
     * 
     */
    public HuipropertygroupPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject huipropertygroup, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(HitroViewsRepository.Huipropertygroup.Properties.depends)) {
                dependsSettings = new ReferencesTableSettings(huipropertygroup,
            ...
            if (isAccessible(HitroViewsRepository.Huipropertygroup.Properties.huiproperty)) {
                huipropertySettings = new ReferencesTableSettings(huipropertygroup,
            ...
            if (isAccessible(HitroViewsRepository.Huipropertygroup.Properties.columns)) {
                basePart.setColumns(EEFConverterUtil.convertToString(XMLTypePackage.Literals.INT,
                        huipropertygroup.getColumns()));
            }
                ...
                basePart.addFilterToHuiproperty(new ViewerFilter() {
                    ...
                    public boolean select(Viewer viewer, Object parentElement, Object element) {
                        return (element instanceof String && element.equals("")) //$NON-NLS-1$
                                || (element instanceof Huiproperty);
                    }
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (HitroViewsRepository.Huipropertygroup.Properties.huiproperty == event
                .getAffectedEditor()) {
            if (event.getKind() == PropertiesEditionEvent.ADD) {
                EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(
                        editingContext, this, huipropertySettings,
        ...
        if (HitroViewsRepository.Huipropertygroup.Properties.columns == event.getAffectedEditor()) {
            huipropertygroup
                    .setColumns((EEFConverterUtil.createIntFromString(XMLTypePackage.Literals.INT,
                            (String) event.getNewValue())));
        }
        if (HitroViewsRepository.Huipropertygroup.Base.id == event.getAffectedEditor()) {
            huipropertygroup.setId((java.lang.String) EEFConverterUtil
        ...
        if (HitroViewsRepository.Huipropertygroup.Base.name == event.getAffectedEditor()) {
            huipropertygroup.setName((java.lang.String) EEFConverterUtil.createFromString(
        ...
        if (HitroViewsRepository.Huipropertygroup.Properties.tags == event.getAffectedEditor()) {
            huipropertygroup.setTags((java.lang.String) EEFConverterUtil.createFromString(
                    XMLTypePackage.Literals.STRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (HitroPackage.eINSTANCE.getHuipropertygroup_Depends().equals(msg.getFeature())
                    && isAccessible(HitroViewsRepository.Huipropertygroup.Properties.depends))
                basePart.updateDepends();
            if (HitroPackage.eINSTANCE.getHuipropertygroup_Huiproperty().equals(msg.getFeature())
                    && isAccessible(HitroViewsRepository.Huipropertygroup.Properties.huiproperty))
                basePart.updateHuiproperty();
            if (HitroPackage.eINSTANCE.getHuipropertygroup_Columns().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(HitroViewsRepository.Huipropertygroup.Properties.columns)) {
                if (msg.getNewValue() != null) {
                    basePart.setColumns(EcoreUtil.convertToString(XMLTypePackage.Literals.INT,
                            msg.getNewValue()));
                } else {
                    basePart.setColumns("");
                }
            }
            if (HitroPackage.eINSTANCE.getHuipropertygroup_Id().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(HitroViewsRepository.Huipropertygroup.Base.id)) {
                if (msg.getNewValue() != null) {
            ...
            if (HitroPackage.eINSTANCE.getHuipropertygroup_Name().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(HitroViewsRepository.Huipropertygroup.Base.name)) {
                if (msg.getNewValue() != null) {
            ...
            if (HitroPackage.eINSTANCE.getHuipropertygroup_Tags().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(HitroViewsRepository.Huipropertygroup.Properties.tags)) {
                if (msg.getNewValue() != null) {
    ...
    public boolean isRequired(Object key, int kind) {
        return key == HitroViewsRepository.Huipropertygroup.Base.id
                || key == HitroViewsRepository.Huipropertygroup.Base.name;
    }
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                if (HitroViewsRepository.Huipropertygroup.Properties.columns == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(HitroPackage.eINSTANCE
                                .getHuipropertygroup_Columns().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(HitroPackage.eINSTANCE
                            .getHuipropertygroup_Columns().getEAttributeType(), newValue);
                }
                if (HitroViewsRepository.Huipropertygroup.Base.id == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                HitroPackage.eINSTANCE.getHuipropertygroup_Id().getEAttributeType(),
                                (String) newValue);
                    }
                ...
                if (HitroViewsRepository.Huipropertygroup.Base.name == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(HitroPackage.eINSTANCE
                                .getHuipropertygroup_Name().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            HitroPackage.eINSTANCE.getHuipropertygroup_Name().getEAttributeType(),
                            newValue);
                }
                if (HitroViewsRepository.Huipropertygroup.Properties.tags == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(HitroPackage.eINSTANCE
                                .getHuipropertygroup_Tags().getEAttributeType(), (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            HitroPackage.eINSTANCE.getHuipropertygroup_Tags().getEAttributeType(),
                            newValue);
                }
