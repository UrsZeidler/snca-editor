...
public class HuirelationPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public HuirelationPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject huirelation, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(HitroViewsRepository.Huirelation.Properties.reversename))
                basePart.setReversename(EEFConverterUtil.convertToString(
                        XMLTypePackage.Literals.STRING, huirelation.getReversename()));

            if (isAccessible(HitroViewsRepository.Huirelation.Properties.to)) {
                // init part
                toSettings = new EObjectFlatComboSettings(huirelation,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (HitroViewsRepository.Huirelation.Base.id == event.getAffectedEditor()) {
            huirelation.setId((java.lang.String) EEFConverterUtil
        ...
        if (HitroViewsRepository.Huirelation.Base.name == event.getAffectedEditor()) {
            huirelation.setName((java.lang.String) EEFConverterUtil.createFromString(
        ...
        if (HitroViewsRepository.Huirelation.Properties.reversename == event.getAffectedEditor()) {
            huirelation.setReversename((java.lang.String) EEFConverterUtil.createFromString(
                    XMLTypePackage.Literals.STRING, (String) event.getNewValue()));
        }
        ...
        if (HitroViewsRepository.Huirelation.Properties.tooltip == event.getAffectedEditor()) {
            huirelation.setTooltip((java.lang.String) EEFConverterUtil.createFromString(
                    XMLTypePackage.Literals.STRING, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (HitroPackage.eINSTANCE.getHuirelation_Id().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(HitroViewsRepository.Huirelation.Base.id)) {
            ...
            if (HitroPackage.eINSTANCE.getHuirelation_Name().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(HitroViewsRepository.Huirelation.Base.name)) {
                if (msg.getNewValue() != null) {
            ...
            if (HitroPackage.eINSTANCE.getHuirelation_Reversename().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(HitroViewsRepository.Huirelation.Properties.reversename)) {
                if (msg.getNewValue() != null) {
                    basePart.setReversename(EcoreUtil
                            .convertToString(XMLTypePackage.Literals.STRING, msg.getNewValue()));
                } else {
                    basePart.setReversename("");
                }
            }
            if (HitroPackage.eINSTANCE.getHuirelation_To().equals(msg.getFeature())
                    && basePart != null
                    && isAccessible(HitroViewsRepository.Huirelation.Properties.to))
                basePart.setTo((EObject) msg.getNewValue());
            if (HitroPackage.eINSTANCE.getHuirelation_Tooltip().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(HitroViewsRepository.Huirelation.Properties.tooltip)) {
                if (msg.getNewValue() != null) {
    ...
    public boolean isRequired(Object key, int kind) {
        return key == HitroViewsRepository.Huirelation.Base.id
                || key == HitroViewsRepository.Huirelation.Properties.to;
    }
        ...
        if (event.getNewValue() != null) {
            try {
                if (HitroViewsRepository.Huirelation.Base.id == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                HitroPackage.eINSTANCE.getHuirelation_Id().getEAttributeType(),
                                (String) newValue);
                    }
                ...
                if (HitroViewsRepository.Huirelation.Base.name == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                HitroPackage.eINSTANCE.getHuirelation_Name().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            HitroPackage.eINSTANCE.getHuirelation_Name().getEAttributeType(),
                ...
                if (HitroViewsRepository.Huirelation.Properties.reversename == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(HitroPackage.eINSTANCE
                                .getHuirelation_Reversename().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            HitroPackage.eINSTANCE.getHuirelation_Reversename().getEAttributeType(),
                            newValue);
                }
                if (HitroViewsRepository.Huirelation.Properties.tooltip == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                HitroPackage.eINSTANCE.getHuirelation_Tooltip().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            HitroPackage.eINSTANCE.getHuirelation_Tooltip().getEAttributeType(),
