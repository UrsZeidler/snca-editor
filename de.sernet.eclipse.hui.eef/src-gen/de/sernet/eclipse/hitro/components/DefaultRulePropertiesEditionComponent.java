...
public class DefaultRulePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public DefaultRulePropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject defaultRule, String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(HitroViewsRepository.DefaultRule.Properties.param)) {
                paramSettings = new ReferencesTableSettings(defaultRule,
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (HitroViewsRepository.DefaultRule.Properties.class_ == event.getAffectedEditor()) {
            defaultRule.setClass((java.lang.String) EEFConverterUtil.createFromString(
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (HitroPackage.eINSTANCE.getDefaultRule_Param().equals(msg.getFeature())
                    && isAccessible(HitroViewsRepository.DefaultRule.Properties.param))
                basePart.updateParam();
            if (HitroPackage.eINSTANCE.getDefaultRule_Class().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(HitroViewsRepository.DefaultRule.Properties.class_)) {
    ...
    public Diagnostic validateValue(IPropertiesEditionEvent event) {
        ...
        if (event.getNewValue() != null) {
            try {
                if (HitroViewsRepository.DefaultRule.Properties.class_ == event
                        .getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                HitroPackage.eINSTANCE.getDefaultRule_Class().getEAttributeType(),
                                (String) newValue);
                    }
