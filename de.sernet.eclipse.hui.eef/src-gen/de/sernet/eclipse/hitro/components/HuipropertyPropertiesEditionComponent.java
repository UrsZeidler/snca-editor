...
public class HuipropertyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public HuipropertyPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject huiproperty, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(HitroViewsRepository.Huiproperty.Properties.defaultValue)) {
				basePart.setDefaultValue(EEFConverterUtil.convertToString(XMLTypePackage.Literals.INT, huiproperty.getDefaultValue()));
			}
			...
			if (isAccessible(HitroViewsRepository.Huiproperty.Properties.tags))
				basePart.setTags(EEFConverterUtil.convertToString(XMLTypePackage.Literals.STRING, huiproperty.getTags()));
			
			if (isAccessible(HitroViewsRepository.Huiproperty.Properties.textrows)) {
				basePart.setTextrows(EEFConverterUtil.convertToString(XMLTypePackage.Literals.INT, huiproperty.getTextrows()));
			}
			
			if (isAccessible(HitroViewsRepository.Huiproperty.Properties.tooltip))
				basePart.setTooltip(EEFConverterUtil.convertToString(XMLTypePackage.Literals.STRING, huiproperty.getTooltip()));
			...
			if (isAccessible(HitroViewsRepository.Huiproperty.Properties.depends)) {
				basePart.addFilterToDepends(new ViewerFilter() {
					...
					public boolean select(Viewer viewer, Object parentElement, Object element) {
						return (element instanceof String && element.equals("")) || (element instanceof Depends); //$NON-NLS-1$ 
					}
			...
			if (isAccessible(HitroViewsRepository.Huiproperty.Properties.validationRule)) {
				basePart.addFilterToValidationRule(new ViewerFilter() {
					 ...
					 */
					public boolean select(Viewer viewer, Object parentElement, Object element) {
						return (element instanceof String && element.equals("")) || (element instanceof ValidationRule); //$NON-NLS-1$ 
					}
			...
			if (isAccessible(HitroViewsRepository.Huiproperty.Properties.option)) {
				basePart.addFilterToOption(new ViewerFilter() {
					 ...
					 */
					public boolean select(Viewer viewer, Object parentElement, Object element) {
						return (element instanceof String && element.equals("")) || (element instanceof Option); //$NON-NLS-1$ 
					}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (HitroViewsRepository.Huiproperty.Properties.defaultValue == event.getAffectedEditor()) {
			huiproperty.setDefaultValue((EEFConverterUtil.createIntFromString(XMLTypePackage.Literals.INT, (String)event.getNewValue())));
		}
		...
		if (HitroViewsRepository.Huiproperty.Properties.showInObjectBrowser == event.getAffectedEditor()) {
		...
		if (HitroViewsRepository.Huiproperty.Properties.tags == event.getAffectedEditor()) {
			huiproperty.setTags((java.lang.String)EEFConverterUtil.createFromString(XMLTypePackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (HitroViewsRepository.Huiproperty.Properties.textrows == event.getAffectedEditor()) {
			huiproperty.setTextrows((EEFConverterUtil.createIntFromString(XMLTypePackage.Literals.INT, (String)event.getNewValue())));
		}
		if (HitroViewsRepository.Huiproperty.Properties.tooltip == event.getAffectedEditor()) {
			huiproperty.setTooltip((java.lang.String)EEFConverterUtil.createFromString(XMLTypePackage.Literals.STRING, (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (HitroPackage.eINSTANCE.getHuiproperty_DefaultValue().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(HitroViewsRepository.Huiproperty.Properties.defaultValue)) {
				if (msg.getNewValue() != null) {
					basePart.setDefaultValue(EcoreUtil.convertToString(XMLTypePackage.Literals.INT, msg.getNewValue()));
				} else {
					basePart.setDefaultValue("");
				}
			}
			if (HitroPackage.eINSTANCE.getHuiproperty_Editable().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(HitroViewsRepository.Huiproperty.Properties.editable))
			...
			if (HitroPackage.eINSTANCE.getHuiproperty_Report().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(HitroViewsRepository.Huiproperty.Properties.report))
				basePart.setReport((Boolean)msg.getNewValue());
			
			if (HitroPackage.eINSTANCE.getHuiproperty_Required().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(HitroViewsRepository.Huiproperty.Properties.required))
				basePart.setRequired((Boolean)msg.getNewValue());
			
			if (HitroPackage.eINSTANCE.getHuiproperty_ShowInObjectBrowser().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(HitroViewsRepository.Huiproperty.Properties.showInObjectBrowser))
				basePart.setShowInObjectBrowser((Boolean)msg.getNewValue());
			
			if (HitroPackage.eINSTANCE.getHuiproperty_Tags().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(HitroViewsRepository.Huiproperty.Properties.tags)) {
				if (msg.getNewValue() != null) {
			...
			if (HitroPackage.eINSTANCE.getHuiproperty_Textrows().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(HitroViewsRepository.Huiproperty.Properties.textrows)) {
				if (msg.getNewValue() != null) {
					basePart.setTextrows(EcoreUtil.convertToString(XMLTypePackage.Literals.INT, msg.getNewValue()));
				} else {
					basePart.setTextrows("");
				}
			}
			if (HitroPackage.eINSTANCE.getHuiproperty_Tooltip().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(HitroViewsRepository.Huiproperty.Properties.tooltip)) {
				if (msg.getNewValue() != null) {
			...
			if (HitroPackage.eINSTANCE.getHuiproperty_Visible().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(HitroViewsRepository.Huiproperty.Properties.visible))
			...
			try {
				if (HitroViewsRepository.Huiproperty.Properties.crudButtons == event.getAffectedEditor()) {
					...
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HitroPackage.eINSTANCE.getHuiproperty_CrudButtons().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HitroPackage.eINSTANCE.getHuiproperty_CrudButtons().getEAttributeType(), newValue);
				}
				if (HitroViewsRepository.Huiproperty.Properties.defaultValue == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HitroPackage.eINSTANCE.getHuiproperty_DefaultValue().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HitroPackage.eINSTANCE.getHuiproperty_DefaultValue().getEAttributeType(), newValue);
				}
				if (HitroViewsRepository.Huiproperty.Properties.editable == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HitroPackage.eINSTANCE.getHuiproperty_Editable().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HitroPackage.eINSTANCE.getHuiproperty_Editable().getEAttributeType(), newValue);
				}
				if (HitroViewsRepository.Huiproperty.Properties.focus == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HitroPackage.eINSTANCE.getHuiproperty_Focus().getEAttributeType(), (String)newValue);
					}
				...
				if (HitroViewsRepository.Huiproperty.Properties.name == event.getAffectedEditor()) {
					...
					ret = Diagnostician.INSTANCE.validate(HitroPackage.eINSTANCE.getHuiproperty_Name().getEAttributeType(), newValue);
				}
				if (HitroViewsRepository.Huiproperty.Properties.report == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HitroPackage.eINSTANCE.getHuiproperty_Report().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HitroPackage.eINSTANCE.getHuiproperty_Report().getEAttributeType(), newValue);
				}
				if (HitroViewsRepository.Huiproperty.Properties.required == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HitroPackage.eINSTANCE.getHuiproperty_Required().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HitroPackage.eINSTANCE.getHuiproperty_Required().getEAttributeType(), newValue);
				}
				if (HitroViewsRepository.Huiproperty.Properties.showInObjectBrowser == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HitroPackage.eINSTANCE.getHuiproperty_ShowInObjectBrowser().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HitroPackage.eINSTANCE.getHuiproperty_ShowInObjectBrowser().getEAttributeType(), newValue);
				}
				if (HitroViewsRepository.Huiproperty.Properties.tags == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HitroPackage.eINSTANCE.getHuiproperty_Tags().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HitroPackage.eINSTANCE.getHuiproperty_Tags().getEAttributeType(), newValue);
				}
				if (HitroViewsRepository.Huiproperty.Properties.textrows == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HitroPackage.eINSTANCE.getHuiproperty_Textrows().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HitroPackage.eINSTANCE.getHuiproperty_Textrows().getEAttributeType(), newValue);
				}
				if (HitroViewsRepository.Huiproperty.Properties.tooltip == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HitroPackage.eINSTANCE.getHuiproperty_Tooltip().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HitroPackage.eINSTANCE.getHuiproperty_Tooltip().getEAttributeType(), newValue);
				}
				if (HitroViewsRepository.Huiproperty.Properties.visible == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HitroPackage.eINSTANCE.getHuiproperty_Visible().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HitroPackage.eINSTANCE.getHuiproperty_Visible().getEAttributeType(), newValue);
				}
