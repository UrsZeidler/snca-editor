...
public class OptionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public OptionPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject option,
            String editing_mode) {
    ...
    public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
        ...
        if (editingPart != null && key == partKey) {
            ...
            if (isAccessible(HitroViewsRepository.Option.Properties.value))
                basePart.setValue(EEFConverterUtil.convertToString(XMLTypePackage.Literals.DECIMAL,
                        option.getValue()));
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (HitroViewsRepository.Option.Properties.id == event.getAffectedEditor()) {
            option.setId((java.lang.String) EEFConverterUtil
        ...
        if (HitroViewsRepository.Option.Properties.name == event.getAffectedEditor()) {
            option.setName((java.lang.String) EEFConverterUtil.createFromString(
        ...
        if (HitroViewsRepository.Option.Properties.value == event.getAffectedEditor()) {
            option.setValue((java.math.BigDecimal) EEFConverterUtil.createFromString(
                    XMLTypePackage.Literals.DECIMAL, (String) event.getNewValue()));
        }
    }
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (HitroPackage.eINSTANCE.getOption_Id().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(HitroViewsRepository.Option.Properties.id)) {
            ...
            if (HitroPackage.eINSTANCE.getOption_Name().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(HitroViewsRepository.Option.Properties.name)) {
                if (msg.getNewValue() != null) {
            ...
            if (HitroPackage.eINSTANCE.getOption_Value().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(HitroViewsRepository.Option.Properties.value)) {
                if (msg.getNewValue() != null) {
                    basePart.setValue(EcoreUtil.convertToString(XMLTypePackage.Literals.DECIMAL,
                            msg.getNewValue()));
                } else {
                    basePart.setValue("");
                }
    ...
    protected NotificationFilter[] getNotificationFilters() {
        NotificationFilter filter = new EStructuralFeatureNotificationFilter(
                HitroPackage.eINSTANCE.getOption_Id(), HitroPackage.eINSTANCE.getOption_Name(),
                ...
                if (HitroViewsRepository.Option.Properties.id == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                HitroPackage.eINSTANCE.getOption_Id().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            HitroPackage.eINSTANCE.getOption_Id().getEAttributeType(), newValue);
                }
                if (HitroViewsRepository.Option.Properties.name == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                HitroPackage.eINSTANCE.getOption_Name().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            HitroPackage.eINSTANCE.getOption_Name().getEAttributeType(), newValue);
                }
                if (HitroViewsRepository.Option.Properties.value == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                HitroPackage.eINSTANCE.getOption_Value().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            HitroPackage.eINSTANCE.getOption_Value().getEAttributeType(), newValue);
                }
