...
public class HuientityPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
     ...
     * 
     */
    public HuientityPropertiesEditionComponent(PropertiesEditingContext editingContext,
            EObject huientity, String editing_mode) {
    ...
    public void updateSemanticModel(final IPropertiesEditionEvent event) {
        ...
        if (HitroViewsRepository.Huientity.Base.id == event.getAffectedEditor()) {
            huientity.setId((java.lang.String) EEFConverterUtil
        ...
        if (HitroViewsRepository.Huientity.Base.name == event.getAffectedEditor()) {
            huientity.setName((java.lang.String) EEFConverterUtil.createFromString(
    ...
    public void updatePart(Notification msg) {
        ...
        if (editingPart.isVisible()) {
            ...
            if (HitroPackage.eINSTANCE.getHuientity_Id().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(HitroViewsRepository.Huientity.Base.id)) {
            ...
            if (HitroPackage.eINSTANCE.getHuientity_Name().equals(msg.getFeature())
                    && msg.getNotifier().equals(semanticObject) && basePart != null
                    && isAccessible(HitroViewsRepository.Huientity.Base.name)) {
                if (msg.getNewValue() != null) {
    ...
    public boolean mustBeComposed(Object key, int kind) {
        return key == HitroViewsRepository.Huientity.Base.id
                || key == HitroViewsRepository.Huientity.Base.name
                || key == HitroViewsRepository.Huientity.Base.class;
    }
                ...
                if (HitroViewsRepository.Huientity.Base.id == event.getAffectedEditor()) {
                    ...
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                HitroPackage.eINSTANCE.getHuientity_Id().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            HitroPackage.eINSTANCE.getHuientity_Id().getEAttributeType(), newValue);
                }
                if (HitroViewsRepository.Huientity.Base.name == event.getAffectedEditor()) {
                    Object newValue = event.getNewValue();
                    if (newValue instanceof String) {
                        newValue = EEFConverterUtil.createFromString(
                                HitroPackage.eINSTANCE.getHuientity_Name().getEAttributeType(),
                                (String) newValue);
                    }
                    ret = Diagnostician.INSTANCE.validate(
                            HitroPackage.eINSTANCE.getHuientity_Name().getEAttributeType(),
