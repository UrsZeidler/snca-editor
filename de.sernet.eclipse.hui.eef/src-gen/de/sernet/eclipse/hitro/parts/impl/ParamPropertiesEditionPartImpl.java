 ...
 * 
 */
public class ParamPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, ParamPropertiesEditionPart {
    ...
    protected Composite createIdText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ParamPropertiesEditionPartImpl.this,
                ...
                if (e.character == SWT.CR) {
                    if (propertiesEditionComponent != null)
                        propertiesEditionComponent.firePropertiesChanged(
                                new PropertiesEditionEvent(ParamPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                HitroViewsRepository.Param.Properties.id, HitroViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMixedMultiValuedEditor(Composite parent) {
        ...
        editMixed.setText(getDescription(HitroViewsRepository.Param.Properties.mixed,
