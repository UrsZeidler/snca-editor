 ...
 * 
 */
public class DependsPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, DependsPropertiesEditionPart {
    ...
    protected Composite createInverseCheckbox(Composite parent) {
        ...
        inverse.setText(getDescription(HitroViewsRepository.Depends.Properties.inverse,
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DependsPropertiesEditionPartImpl.this,
        ...
        option.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                propertiesEditionComponent.firePropertiesChanged(
                        new PropertiesEditionEvent(DependsPropertiesEditionPartImpl.this,
                                HitroViewsRepository.Depends.Properties.option,
                                PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null,
                                getOption()));
            }
