 ...
 * 
 */
public class OptionPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, OptionPropertiesEditionPart {
    ...
    protected Composite createIdText(Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(OptionPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                HitroViewsRepository.Option.Properties.id, HitroViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createNameText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        HitroViewsRepository.Option.Properties.name, HitroViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createValueText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                HitroViewsRepository.Option.Properties.value, HitroViewsRepository.SWT_KIND), null); // $NON-NLS-1$
