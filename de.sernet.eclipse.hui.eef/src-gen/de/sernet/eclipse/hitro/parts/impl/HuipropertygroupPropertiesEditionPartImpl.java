 ...
 * 
 */
public class HuipropertygroupPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, HuipropertygroupPropertiesEditionPart {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            HuipropertygroupPropertiesEditionPartImpl.this,
    ...
    protected Composite createDependsAdvancedReferencesTable(Composite parent) {
        String label = getDescription(HitroViewsRepository.Huipropertygroup.Properties.depends,
