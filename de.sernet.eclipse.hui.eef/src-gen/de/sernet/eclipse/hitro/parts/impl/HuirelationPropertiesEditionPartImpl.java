 ...
 * 
 */
public class HuirelationPropertiesEditionPartImpl extends CompositePropertiesEditionPart
        implements ISWTPropertiesEditionPart, HuirelationPropertiesEditionPart {
    ...
    public void createControls(Composite view) {
        CompositionSequence huirelationStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        CompositionStep baseStep = huirelationStep
                .addStep(HitroViewsRepository.Huirelation.Base.class);
        baseStep.addStep(HitroViewsRepository.Huirelation.Base.id);
        baseStep.addStep(HitroViewsRepository.Huirelation.Base.name);

        CompositionStep propertiesStep = huirelationStep
                .addStep(HitroViewsRepository.Huirelation.Properties.class);
    ...
    protected Composite createIdText(Composite parent) {
        createDescription(parent, HitroViewsRepository.Huirelation.Base.id,
                HitroMessages.HuirelationPropertiesEditionPart_IdLabel);
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            HuirelationPropertiesEditionPartImpl.this,
                            HitroViewsRepository.Huirelation.Base.id, PropertiesEditionEvent.COMMIT,
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
                HitroViewsRepository.Huirelation.Base.id, HitroViewsRepository.SWT_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createNameText(Composite parent) {
        createDescription(parent, HitroViewsRepository.Huirelation.Base.name,
                HitroMessages.HuirelationPropertiesEditionPart_NameLabel);
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(HuirelationPropertiesEditionPartImpl.this,
        ...
        SWTUtils.createHelpButton(parent,
                propertiesEditionComponent.getHelpContent(
                        HitroViewsRepository.Huirelation.Base.name, HitroViewsRepository.SWT_KIND),
                null); // $NON-NLS-1$
    ...
    protected Composite createPropertiesGroup(Composite parent) {
        ...
        propertiesGroup
                .setText(HitroMessages.HuirelationPropertiesEditionPart_PropertiesGroupLabel);
    ...
    protected Composite createReversenameText(Composite parent) {
        createDescription(parent, HitroViewsRepository.Huirelation.Properties.reversename,
                HitroMessages.HuirelationPropertiesEditionPart_ReversenameLabel);
    ...
    protected Composite createToFlatComboViewer(Composite parent) {
        createDescription(parent, HitroViewsRepository.Huirelation.Properties.to,
                HitroMessages.HuirelationPropertiesEditionPart_ToLabel);
        to = new EObjectFlatComboViewer(parent,
                !propertiesEditionComponent.isRequired(
                        HitroViewsRepository.Huirelation.Properties.to,
                        HitroViewsRepository.SWT_KIND));
        ...
        to.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                        HuirelationPropertiesEditionPartImpl.this,
                        HitroViewsRepository.Huirelation.Properties.to,
                        PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getTo()));
            }
    ...
    protected Composite createTooltipText(Composite parent) {
        createDescription(parent, HitroViewsRepository.Huirelation.Properties.tooltip,
                HitroMessages.HuirelationPropertiesEditionPart_TooltipLabel);
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.HuirelationPropertiesEditionPart#setId(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.HuirelationPropertiesEditionPart#setName(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.HuirelationPropertiesEditionPart#setReversename(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.HuirelationPropertiesEditionPart#setTo(EObject
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.HuirelationPropertiesEditionPart#setToButtonMode(ButtonsModeEnum
     *      newValue)
     */
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.HuirelationPropertiesEditionPart#addFilterTo(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.HuirelationPropertiesEditionPart#addBusinessFilterTo(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.HuirelationPropertiesEditionPart#setTooltip(String
     *      newValue)
     * 
     */
