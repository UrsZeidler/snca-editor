 ...
 * 
 */
public class ValidationRulePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ValidationRulePropertiesEditionPart {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(HitroMessages.ValidationRulePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createParamAdvancedTableComposition(Composite parent) {
		this.param = new ReferencesTable(getDescription(HitroViewsRepository.ValidationRule.Properties.param, HitroMessages.ValidationRulePropertiesEditionPart_ParamLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ValidationRulePropertiesEditionPartImpl.this, HitroViewsRepository.ValidationRule.Properties.param, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				param.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ValidationRulePropertiesEditionPartImpl.this, HitroViewsRepository.ValidationRule.Properties.param, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				param.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ValidationRulePropertiesEditionPartImpl.this, HitroViewsRepository.ValidationRule.Properties.param, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				param.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ValidationRulePropertiesEditionPartImpl.this, HitroViewsRepository.ValidationRule.Properties.param, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				param.refresh();
			}
		...
		this.param.setHelpText(propertiesEditionComponent.getHelpContent(HitroViewsRepository.ValidationRule.Properties.param, HitroViewsRepository.SWT_KIND));
		this.param.createControls(parent);
		this.param.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ValidationRulePropertiesEditionPartImpl.this, HitroViewsRepository.ValidationRule.Properties.param, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createClass_Text(Composite parent) {
		...
		class_.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ValidationRulePropertiesEditionPartImpl.this, HitroViewsRepository.ValidationRule.Properties.class_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, class_.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(HitroViewsRepository.ValidationRule.Properties.class_, HitroViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createHintText(Composite parent) {
		...
		hint.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ValidationRulePropertiesEditionPartImpl.this, HitroViewsRepository.ValidationRule.Properties.hint, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, hint.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(HitroViewsRepository.ValidationRule.Properties.hint, HitroViewsRepository.SWT_KIND), null); //$NON-NLS-1$
