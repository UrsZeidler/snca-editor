...
public class HitroViewsRepository {
	...
	public static class DocumentRoot {
		public static class Properties {
			...
			public static String xMLNSPrefixMap = "hitro::DocumentRoot::properties::xMLNSPrefixMap";
			
			
			public static String xSISchemaLocation = "hitro::DocumentRoot::properties::xSISchemaLocation";
