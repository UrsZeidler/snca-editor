 ...
 * 
 */
public class HuientitiesPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, HuientitiesPropertiesEditionPart {
	 ...
	 */
	public HuientitiesPropertiesEditionPartForm() { super(); }
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(HitroMessages.HuientitiesPropertiesEditionPart_PropertiesGroupLabel);
	 ...
	 * 
	 */
	protected Composite createHuientityTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.huientity = new ReferencesTable(getDescription(HitroViewsRepository.Huientities.Properties.huientity, HitroMessages.HuientitiesPropertiesEditionPart_HuientityLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HuientitiesPropertiesEditionPartForm.this, HitroViewsRepository.Huientities.Properties.huientity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				huientity.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HuientitiesPropertiesEditionPartForm.this, HitroViewsRepository.Huientities.Properties.huientity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				huientity.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HuientitiesPropertiesEditionPartForm.this, HitroViewsRepository.Huientities.Properties.huientity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				huientity.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HuientitiesPropertiesEditionPartForm.this, HitroViewsRepository.Huientities.Properties.huientity, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				huientity.refresh();
			}
		...
		this.huientity.setHelpText(propertiesEditionComponent.getHelpContent(HitroViewsRepository.Huientities.Properties.huientity, HitroViewsRepository.FORM_KIND));
		...
		this.huientity.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(HuientitiesPropertiesEditionPartForm.this, HitroViewsRepository.Huientities.Properties.huientity, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
