 ...
 * 
 */
public class DependsPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, DependsPropertiesEditionPart {
     ...
     */
    public DependsPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        CompositionSequence dependsStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        CompositionStep propertiesStep = dependsStep
                .addStep(HitroViewsRepository.Depends.Properties.class);
    ...
    protected Composite createInverseCheckbox(FormToolkit widgetFactory, Composite parent) {
        inverse = widgetFactory
                .createButton(parent,
                        getDescription(HitroViewsRepository.Depends.Properties.inverse,
                                HitroMessages.DependsPropertiesEditionPart_InverseLabel),
                        SWT.CHECK);
            ...
            public void widgetSelected(SelectionEvent e) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DependsPropertiesEditionPartForm.this,
                                    HitroViewsRepository.Depends.Properties.inverse,
                                    PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
                                    new Boolean(inverse.getSelection())));
            }
    ...
    protected Composite createOptionFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
        createDescription(parent, HitroViewsRepository.Depends.Properties.option,
                HitroMessages.DependsPropertiesEditionPart_OptionLabel);
        option = new EObjectFlatComboViewer(parent,
                !propertiesEditionComponent.isRequired(
                        HitroViewsRepository.Depends.Properties.option,
                        HitroViewsRepository.FORM_KIND));
    ...
    protected Composite createValueText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, HitroViewsRepository.Depends.Properties.value,
                HitroMessages.DependsPropertiesEditionPart_ValueLabel);
        ...
        value.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(DependsPropertiesEditionPartForm.this, null,
                                    PropertiesEditionEvent.FOCUS_CHANGED,
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.DependsPropertiesEditionPart#setInverse(Boolean
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.DependsPropertiesEditionPart#setOption(EObject
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.DependsPropertiesEditionPart#setOptionButtonMode(ButtonsModeEnum
     *      newValue)
     */
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.DependsPropertiesEditionPart#addFilterOption(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.DependsPropertiesEditionPart#addBusinessFilterOption(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.DependsPropertiesEditionPart#setValue(String
     *      newValue)
     * 
     */
