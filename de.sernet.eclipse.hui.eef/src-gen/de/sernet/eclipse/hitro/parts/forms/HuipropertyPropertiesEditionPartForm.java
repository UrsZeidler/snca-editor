 ...
 * 
 */
public class HuipropertyPropertiesEditionPartForm extends SectionPropertiesEditingPart
     ...
     */
    public HuipropertyPropertiesEditionPartForm() {
        super();
    }
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(HuipropertyPropertiesEditionPartForm.this,
                ...
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(HuipropertyPropertiesEditionPartForm.this,
                                    HitroViewsRepository.Huiproperty.Type.min,
                                    PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, min.getText()));
                }
            }
                ...
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(HuipropertyPropertiesEditionPartForm.this,
                                    HitroViewsRepository.Huiproperty.Type.max,
                                    PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, max.getText()));
                }
            }
    ...
    protected Composite createCrudButtonsCheckbox(FormToolkit widgetFactory, Composite parent) {
        crudButtons = widgetFactory.createButton(parent,
                getDescription(HitroViewsRepository.Huiproperty.Properties.crudButtons,
                ...
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(HuipropertyPropertiesEditionPartForm.this,
                                    HitroViewsRepository.Huiproperty.Properties.tags,
                                    PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, tags.getText()));
                }
            }
                ...
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(HuipropertyPropertiesEditionPartForm.this,
                                    HitroViewsRepository.Huiproperty.Properties.textrows,
                                    PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, textrows.getText()));
                }
            }
