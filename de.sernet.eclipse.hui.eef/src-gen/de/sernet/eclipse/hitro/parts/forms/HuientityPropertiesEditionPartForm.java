 ...
 * 
 */
public class HuientityPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, HuientityPropertiesEditionPart {
     ...
     */
    public HuientityPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createIdText(FormToolkit widgetFactory, Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(HuientityPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                HitroViewsRepository.Huientity.Base.id, HitroViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                HitroViewsRepository.Huientity.Base.name, HitroViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createTestGroup(FormToolkit widgetFactory, final Composite parent) {
        Section testSection = widgetFactory.createSection(parent,
                Section.TITLE_BAR | Section.TWISTIE | Section.EXPANDED);
