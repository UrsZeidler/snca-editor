 ...
 * 
 */
public class ReferencePropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ReferencePropertiesEditionPart {
     ...
     */
    public ReferencePropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        CompositionSequence referenceStep = new BindingCompositionSequence(
                propertiesEditionComponent);
        CompositionStep propertiesStep = referenceStep
                .addStep(HitroViewsRepository.Reference.Properties.class);
    ...
    protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
        ...
        propertiesSection
                .setText(HitroMessages.ReferencePropertiesEditionPart_PropertiesGroupLabel);
    ...
    protected Composite createEntitytypeFlatComboViewer(Composite parent,
        ...
        createDescription(parent, HitroViewsRepository.Reference.Properties.entitytype,
                HitroMessages.ReferencePropertiesEditionPart_EntitytypeLabel);
        entitytype = new EObjectFlatComboViewer(parent,
                !propertiesEditionComponent.isRequired(
                        HitroViewsRepository.Reference.Properties.entitytype,
            ...
            public void selectionChanged(SelectionChangedEvent event) {
                if (propertiesEditionComponent != null)
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ReferencePropertiesEditionPartForm.this,
                                    HitroViewsRepository.Reference.Properties.entitytype,
    ...
    protected Composite createLinkTypeText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, HitroViewsRepository.Reference.Properties.linkType,
                HitroMessages.ReferencePropertiesEditionPart_LinkTypeLabel);
                ...
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ReferencePropertiesEditionPartForm.this,
                                    ...
                                    PropertiesEditionEvent.FOCUS_LOST, null, linkType.getText()));
                }
            }
    ...
    public EObject getEntitytype() {
        if (entitytype.getSelection() instanceof StructuredSelection) {
            Object firstElement = ((StructuredSelection) entitytype.getSelection())
                    .getFirstElement();
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.ReferencePropertiesEditionPart#setEntitytype(EObject
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.ReferencePropertiesEditionPart#setEntitytypeButtonMode(ButtonsModeEnum
     *      newValue)
     */
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.ReferencePropertiesEditionPart#addFilterEntitytype(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.ReferencePropertiesEditionPart#addBusinessFilterEntitytype(ViewerFilter
     *      filter)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.ReferencePropertiesEditionPart#setLinkType(String
     *      newValue)
     * 
     */
