 ...
 * 
 */
public class HuirelationPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, HuirelationPropertiesEditionPart {
     ...
     */
    public HuirelationPropertiesEditionPartForm() {
        super();
    }
    ...
    protected Composite createIdText(FormToolkit widgetFactory, Composite parent) {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(HuirelationPropertiesEditionPartForm.this,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                HitroViewsRepository.Huirelation.Base.id, HitroViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
        ...
        FormUtils.createHelpButton(widgetFactory, parent,
                propertiesEditionComponent.getHelpContent(
                        HitroViewsRepository.Huirelation.Base.name, HitroViewsRepository.FORM_KIND),
                null); // $NON-NLS-1$
                ...
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(HuirelationPropertiesEditionPartForm.this,
                                    HitroViewsRepository.Huirelation.Properties.tooltip,
                                    PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, tooltip.getText()));
                }
            }
