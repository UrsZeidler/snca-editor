 ...
 * 
 */
public class ParamPropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ParamPropertiesEditionPart {
     ...
     */
    public ParamPropertiesEditionPartForm() {
        super();
    }
    ...
    public void createControls(final FormToolkit widgetFactory, Composite view) {
        ...
        CompositionStep propertiesStep = paramStep
                .addStep(HitroViewsRepository.Param.Properties.class);
    ...
    protected Composite createIdText(FormToolkit widgetFactory, Composite parent) {
        createDescription(parent, HitroViewsRepository.Param.Properties.id,
                HitroMessages.ParamPropertiesEditionPart_IdLabel);
        ...
        id.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
                            ...
                            HitroViewsRepository.Param.Properties.id, PropertiesEditionEvent.COMMIT,
                            PropertiesEditionEvent.SET, null, id.getText()));
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ParamPropertiesEditionPartForm.this,
            ...
            public void focusGained(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ParamPropertiesEditionPartForm.this, null,
                                    PropertiesEditionEvent.FOCUS_CHANGED,
        ...
        FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
                HitroViewsRepository.Param.Properties.id, HitroViewsRepository.FORM_KIND), null); // $NON-NLS-1$
    ...
    protected Composite createMixedMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
        ...
        editMixed = widgetFactory.createButton(parent,
                getDescription(HitroViewsRepository.Param.Properties.mixed,
                        HitroMessages.ParamPropertiesEditionPart_MixedLabel),
                SWT.NONE);
        ...
        editMixed.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                EEFFeatureEditorDialog dialog = new EEFFeatureEditorDialog(mixed.getShell(),
                        "Param", new AdapterFactoryLabelProvider(adapterFactory), //$NON-NLS-1$
                        mixedList, HitroPackage.eINSTANCE.getParam_Mixed().getEType(), null, false,
                        true, null, null);
                if (dialog.open() == Window.OK) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ParamPropertiesEditionPartForm.this,
                                    HitroViewsRepository.Param.Properties.mixed,
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.ParamPropertiesEditionPart#setId(String
     *      newValue)
     * 
     */
     ...
     * {@inheritDoc}
     * 
     * @see de.sernet.eclipse.hitro.parts.ParamPropertiesEditionPart#setMixed(EList
     *      newValue)
     * 
     */
