 ...
 * 
 */
public class ValidationRulePropertiesEditionPartForm extends SectionPropertiesEditingPart
        implements IFormPropertiesEditionPart, ValidationRulePropertiesEditionPart {
     ...
     */
    public ValidationRulePropertiesEditionPartForm() {
        super();
    }
            ...
            public void focusLost(FocusEvent e) {
                if (propertiesEditionComponent != null) {
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ValidationRulePropertiesEditionPartForm.this,
                ...
                if (propertiesEditionComponent != null) {
                    ...
                    propertiesEditionComponent.firePropertiesChanged(
                            new PropertiesEditionEvent(ValidationRulePropertiesEditionPartForm.this,
                                    HitroViewsRepository.ValidationRule.Properties.hint,
                                    PropertiesEditionEvent.FOCUS_CHANGED,
                                    PropertiesEditionEvent.FOCUS_LOST, null, hint.getText()));
                }
            }
