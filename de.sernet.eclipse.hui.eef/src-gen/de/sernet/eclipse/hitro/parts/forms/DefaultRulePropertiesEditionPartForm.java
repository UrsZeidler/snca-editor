 ...
 * 
 */
public class DefaultRulePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, DefaultRulePropertiesEditionPart {
	 ...
	 */
	public DefaultRulePropertiesEditionPartForm() { super(); }
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(HitroMessages.DefaultRulePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createParamTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.param = new ReferencesTable(getDescription(HitroViewsRepository.DefaultRule.Properties.param, HitroMessages.DefaultRulePropertiesEditionPart_ParamLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DefaultRulePropertiesEditionPartForm.this, HitroViewsRepository.DefaultRule.Properties.param, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				param.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DefaultRulePropertiesEditionPartForm.this, HitroViewsRepository.DefaultRule.Properties.param, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				param.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DefaultRulePropertiesEditionPartForm.this, HitroViewsRepository.DefaultRule.Properties.param, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				param.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DefaultRulePropertiesEditionPartForm.this, HitroViewsRepository.DefaultRule.Properties.param, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				param.refresh();
			}
		...
		this.param.setHelpText(propertiesEditionComponent.getHelpContent(HitroViewsRepository.DefaultRule.Properties.param, HitroViewsRepository.FORM_KIND));
		this.param.createControls(parent, widgetFactory);
		this.param.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DefaultRulePropertiesEditionPartForm.this, HitroViewsRepository.DefaultRule.Properties.param, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createClass_Text(FormToolkit widgetFactory, Composite parent) {
		...
		class_.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DefaultRulePropertiesEditionPartForm.this, HitroViewsRepository.DefaultRule.Properties.class_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, class_.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(HitroViewsRepository.DefaultRule.Properties.class_, HitroViewsRepository.FORM_KIND), null); //$NON-NLS-1$
