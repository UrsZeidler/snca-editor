...
public class DefaultRulePropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof DefaultRule) && (DefaultRulePropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof DefaultRule) && (refinement == DefaultRulePropertiesEditionComponent.class);
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof DefaultRule) && ((DefaultRulePropertiesEditionComponent.BASE_PART.equals(part) && refinement == DefaultRulePropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode) {
		if (editingContext.getEObject() instanceof DefaultRule) {
			return new DefaultRulePropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
		}
