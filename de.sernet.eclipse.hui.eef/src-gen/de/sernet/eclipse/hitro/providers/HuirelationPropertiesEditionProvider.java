...
public class HuirelationPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof Huirelation) && (HuirelationPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof Huirelation) && (refinement == HuirelationPropertiesEditionComponent.class);
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof Huirelation) && ((HuirelationPropertiesEditionComponent.BASE_PART.equals(part) && refinement == HuirelationPropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode) {
		if (editingContext.getEObject() instanceof Huirelation) {
			return new HuirelationPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
		}
