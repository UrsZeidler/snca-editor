...
/**
 * This is the item provider adapter for a {@link de.sernet.eclipse.hitro.Huientity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HuientityItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Huientity_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Huientity_id_feature", "_UI_Huientity_type"),
				 HitroPackage.Literals.HUIENTITY__ID,
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Huientity_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Huientity_name_feature", "_UI_Huientity_type"),
				 HitroPackage.Literals.HUIENTITY__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HitroPackage.Literals.HUIENTITY__GROUP,
				 FeatureMapUtil.createEntry
					(HitroPackage.Literals.HUIENTITY__HUIPROPERTY,
		...
		newChildDescriptors.add
			(createChildParameter
				(HitroPackage.Literals.HUIENTITY__GROUP,
				 FeatureMapUtil.createEntry
					(HitroPackage.Literals.HUIENTITY__HUIPROPERTYGROUP,
		...
		newChildDescriptors.add
			(createChildParameter
				(HitroPackage.Literals.HUIENTITY__GROUP,
				 FeatureMapUtil.createEntry
					(HitroPackage.Literals.HUIENTITY__HUIRELATION,
