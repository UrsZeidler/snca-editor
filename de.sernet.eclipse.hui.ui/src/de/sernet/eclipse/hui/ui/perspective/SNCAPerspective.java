...
public class SNCAPerspective implements IPerspectiveFactory {
    ...
    public void createInitialLayout(IPageLayout layout) {
        ...
        layout.addView("org.eclipse.ui.views.ResourceNavigator", IPageLayout.LEFT, 0.2f,
                IPageLayout.ID_EDITOR_AREA);
        layout.addView("org.eclipse.ui.views.PropertySheet", IPageLayout.RIGHT, 0.54f,
                IPageLayout.ID_EDITOR_AREA);
        layout.addView("org.eclipse.ui.views.ProblemView", IPageLayout.BOTTOM, 0.8f,
                IPageLayout.ID_EDITOR_AREA);
    }
